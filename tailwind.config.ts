...
export default {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        poppins: ["Poppins", "sans-serif"], // Global Poppins font
      },
      // Extended Colors
      colors: {
        ...
        // Custom Colors
        usmPurple: "#4B0082", // Dark Purple (USM branding color)
        gold: "#FFD700", // Golden color for text and accents
        dotted: "#F7C08A", // Dotted pattern color
      },
      // Border Radius
      borderRadius: {
        lg: "var(--radius)",
